...
const AcidSquares = ({
  ...
  useEffect(() => {
    ...
    const a1 = u.uColor1.value; a1[0] = c1[0]; a1[1] = c1[1]; a1[2] = c1[2];
    const c2 = hexToRgb(color2);
    const a2 = u.uColor2.value; a2[0] = c2[0]; a2[1] = c2[1]; a2[2] = c2[2];
    const c3 = hexToRgb(color3);
    const a3 = u.uColor3.value; a3[0] = c3[0]; a3[1] = c3[1]; a3[2] = c3[2];
