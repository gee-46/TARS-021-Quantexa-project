...
export default function BorderGlow({
  ...
  React.useEffect(() => {
    ...
    // Simple animation using setTimeout for brevity
    const step = (prop, start, end, duration) => {
      ...
      const tick = () => {
        ...
        else if (prop === '--edge-proximity') card.classList.remove('sweep-active');
      };
      requestAnimationFrame(tick);
    };
    step('--edge-proximity', 0, 100, 500);
    step('--cursor-angle', angleStart, angleEnd, 2000);
  }, [animated]);
